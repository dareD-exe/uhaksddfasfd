...
const PostShayari = () => {
  ...
  return (
    <div className="bg-[#1B1A55] border border-[#535C91] p-4 rounded-xl text-sm max-w-2xl mx-auto mb-6">
      <h2 className="text-center text-[#9290C3] text-lg font-bold mb-2">
        Post your Shayari
      </h2>
      ...
      <textarea
        ...
        className="w-full h-32 p-4 bg-[#070F2B] text-white border border-[#535C91] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FACC15] font-serif text-lg leading-relaxed resize-none"
      ></textarea>
